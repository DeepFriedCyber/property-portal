...
export const Button = ({ children, variant = 'primary', size = 'md', onClick, className = '', disabled = false, type = 'button' }) => {
    const buttonClassName = clsx('rounded font-semibold transition-colors', {
        // Size variations
    ...
    return (_jsx("button", { onClick: onClick, className: buttonClassName, disabled: disabled, type: type, children: children }));
};
